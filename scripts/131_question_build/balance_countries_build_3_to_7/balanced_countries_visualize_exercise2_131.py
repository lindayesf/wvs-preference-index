"""Exercise 2 visualization for the balanced-country 131-question build.

Reads current Exercise 2 outputs from results/index_131/balanced_countries_exercise2/:
- weighted_variance_sweep_index_*_ym.csv
- weighted_variance_sweep_index_*_y.csv

Writes figures to results/index_131/balanced_countries_exercise2/figures/.
"""
...
def plot_reevaluation_grid(group_name: str, suffix: str, title: str) -> None:
    ...
    fig.suptitle(
        ...
        f"Balanced panel of countries present in WVS waves 3 to 7",
        fontsize=13,
        y=0.99,
    )
...
def main() -> None:
    print("Generating balanced-country Exercise 2 re-evaluation sensitivity charts...")
    for group_name, cfg in REEVAL_GROUPS.items():
        plot_reevaluation_grid(group_name, cfg["suffix"], cfg["title"])
    print(f"\nAll balanced-country Exercise 2 figures saved to {FIG_DIR}/")
