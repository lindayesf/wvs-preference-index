"""Exercise 2 outputs for the balanced-questions 131-question build.

Uses precomputed indices from
results/index_131/balanced_questions_exercise2/preference_it_131_balanced_questions.csv.
...
PREFERENCE_FILE = EX2_DIR / "preference_it_131_balanced_questions.csv"
...
def collapse_colombia_wave3_for_ex2(pref: pd.DataFrame) -> pd.DataFrame:
    ...
    The source preference_it_131_balanced_questions.csv file is not changed.
    """
...
def main():
    ...
    print(f"\nAll balanced-questions Exercise 2 (131-question) results saved to {EX2_DIR}/")
